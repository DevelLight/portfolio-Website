...
function displayProductInfo(product) {
    ...
    const vegan = product.ingredients_text.includes("vegan") || product.ingredients_text.includes("en:vegan") || product.ingredients_text.includes("egg") ||  product.ingredients_text.includes("annimal") || product.ingredients_text.includes("gelatin") || product.ingredients_text.includes("lard");
